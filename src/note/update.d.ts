 ...
 *
 *
 * @generated from protobuf message note.UpdateI
 */
export interface UpdateI {
  /**
   * @generated from protobuf field: note.UpdateI_Filter filter = 100;
   */
  filter?: UpdateI_Filter;
  /**
   * @generated from protobuf field: repeated note.UpdateI_Object object = 200;
   */
  object: UpdateI_Object[];
}
/**
 * @generated from protobuf message note.UpdateI_Filter
 */
export interface UpdateI_Filter {}
/**
 * @generated from protobuf message note.UpdateI_Object
 */
export interface UpdateI_Object {
  /**
   * @generated from protobuf field: note.UpdateI_Object_Intern intern = 100;
   */
  intern?: UpdateI_Object_Intern;
  /**
   * @generated from protobuf field: note.UpdateI_Object_Public public = 200;
   */
  public?: UpdateI_Object_Public;
  /**
   * @generated from protobuf field: note.UpdateI_Object_Symbol symbol = 300;
   */
  symbol?: UpdateI_Object_Symbol;
}
/**
 * @generated from protobuf message note.UpdateI_Object_Intern
 */
export interface UpdateI_Object_Intern {}
/**
 * @generated from protobuf message note.UpdateI_Object_Public
 */
...
/**
 * @generated from protobuf message note.UpdateI_Object_Symbol
 */
 ...
 *
 *
 * @generated from protobuf message note.UpdateO
 */
export interface UpdateO {
  /**
   * @generated from protobuf field: note.UpdateO_Filter filter = 100;
   */
  filter?: UpdateO_Filter;
  /**
   * @generated from protobuf field: repeated note.UpdateO_Object object = 200;
   */
  object: UpdateO_Object[];
}
/**
 * @generated from protobuf message note.UpdateO_Filter
 */
export interface UpdateO_Filter {}
/**
 * @generated from protobuf message note.UpdateO_Object
 */
export interface UpdateO_Object {
  /**
   * @generated from protobuf field: note.UpdateO_Object_Intern intern = 100;
   */
  intern?: UpdateO_Object_Intern;
  /**
   * @generated from protobuf field: note.UpdateO_Object_Public public = 200;
   */
  public?: UpdateO_Object_Public;
}
/**
 * @generated from protobuf message note.UpdateO_Object_Intern
 */
...
/**
 * @generated from protobuf message note.UpdateO_Object_Public
 */
