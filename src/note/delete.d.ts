...
// @generated from protobuf file "pbf/note/delete.proto" (package "note", syntax proto3)
// tslint:disable
 ...
 *
 *
 * @generated from protobuf message note.DeleteI
 */
export interface DeleteI {
  /**
   * @generated from protobuf field: note.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated note.DeleteI_Object object = 200;
   */
  object: DeleteI_Object[];
}
/**
 * @generated from protobuf message note.DeleteI_Filter
 */
export interface DeleteI_Filter {}
/**
 * @generated from protobuf message note.DeleteI_Object
 */
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: note.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: note.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message note.DeleteI_Object_Intern
 */
...
/**
 * @generated from protobuf message note.DeleteI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message note.DeleteO
 */
export interface DeleteO {
  /**
   * @generated from protobuf field: note.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated note.DeleteO_Object object = 200;
   */
  object: DeleteO_Object[];
}
/**
 * @generated from protobuf message note.DeleteO_Filter
 */
export interface DeleteO_Filter {}
/**
 * @generated from protobuf message note.DeleteO_Object
 */
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: note.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: note.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message note.DeleteO_Object_Intern
 */
...
/**
 * @generated from protobuf message note.DeleteO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteI
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteI_Filter
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteI_Object
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteI_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteO
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteO_Filter
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteO_Object
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message note.DeleteO_Object_Public
 */
