...
class SearchI_Object$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* wallet.SearchI_Object_Public public */ 200:
                    ...
                    break;
                case /* wallet.SearchI_Object_Symbol symbol */ 300:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* wallet.SearchI_Object_Symbol symbol = 300; */
        if (message.symbol)
...
class SearchI_Object_Symbol$Type extends MessageType {
    constructor() {
        super("wallet.SearchI_Object_Symbol", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class SearchO_Object$Type extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated wallet.SearchO_Object_Extern extern = 100; */
...
class SearchO_Object_Extern$Type extends MessageType {
    constructor() {
        super("wallet.SearchO_Object_Extern", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
