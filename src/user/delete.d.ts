...
// @generated from protobuf file "pbf/user/delete.proto" (package "user", syntax proto3)
// tslint:disable
 ...
 *
 *
 * @generated from protobuf message user.DeleteI
 */
export interface DeleteI {
  /**
   * @generated from protobuf field: user.DeleteI_Filter filter = 100;
   */
  filter?: DeleteI_Filter;
  /**
   * @generated from protobuf field: repeated user.DeleteI_Object object = 200;
   */
  object: DeleteI_Object[];
}
/**
 * @generated from protobuf message user.DeleteI_Filter
 */
export interface DeleteI_Filter {}
/**
 * @generated from protobuf message user.DeleteI_Object
 */
export interface DeleteI_Object {
  /**
   * @generated from protobuf field: user.DeleteI_Object_Intern intern = 100;
   */
  intern?: DeleteI_Object_Intern;
  /**
   * @generated from protobuf field: user.DeleteI_Object_Public public = 200;
   */
  public?: DeleteI_Object_Public;
}
/**
 * @generated from protobuf message user.DeleteI_Object_Intern
 */
...
/**
 * @generated from protobuf message user.DeleteI_Object_Public
 */
 ...
 *
 *
 * @generated from protobuf message user.DeleteO
 */
export interface DeleteO {
  /**
   * @generated from protobuf field: user.DeleteO_Filter filter = 100;
   */
  filter?: DeleteO_Filter;
  /**
   * @generated from protobuf field: repeated user.DeleteO_Object object = 200;
   */
  object: DeleteO_Object[];
}
/**
 * @generated from protobuf message user.DeleteO_Filter
 */
export interface DeleteO_Filter {}
/**
 * @generated from protobuf message user.DeleteO_Object
 */
export interface DeleteO_Object {
  /**
   * @generated from protobuf field: user.DeleteO_Object_Intern intern = 100;
   */
  intern?: DeleteO_Object_Intern;
  /**
   * @generated from protobuf field: user.DeleteO_Object_Public public = 200;
   */
  public?: DeleteO_Object_Public;
}
/**
 * @generated from protobuf message user.DeleteO_Object_Intern
 */
...
/**
 * @generated from protobuf message user.DeleteO_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteI
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteI_Filter
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteI_Object
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteI_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteI_Object_Public
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteO
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteO_Filter
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteO_Object
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteO_Object_Intern
 */
...
/**
 * @generated MessageType for protobuf message user.DeleteO_Object_Public
 */
