...
class UpdateI_Object_Intern$Type extends MessageType {
    constructor() {
        super("user.UpdateI_Object_Intern", [
...
class UpdateI_Object_Public$Type extends MessageType {
    constructor() {
        super("user.UpdateI_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class UpdateI_Object_Symbol$Type extends MessageType {
    constructor() {
        super("user.UpdateI_Object_Symbol", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class UpdateO_Object_Intern$Type extends MessageType {
    constructor() {
        super("user.UpdateO_Object_Intern", [
