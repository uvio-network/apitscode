...
class DeleteI_Object_Intern$Type extends MessageType {
    constructor() {
        super("user.DeleteI_Object_Intern", [
...
class DeleteI_Object_Public$Type extends MessageType {
    constructor() {
        super("user.DeleteI_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class DeleteO_Object_Intern$Type extends MessageType {
    constructor() {
        super("user.DeleteO_Object_Intern", [
...
class DeleteO_Object_Public$Type extends MessageType {
    constructor() {
        super("user.DeleteO_Object_Public", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
